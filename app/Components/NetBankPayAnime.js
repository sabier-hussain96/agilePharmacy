...
const NetBankPayAnime = () => {
    const navigation = useNavigation()
  return (
    <View style={{ flex: 1, alignItems: 'center', margin: 'auto', backgroundColor: '#ADE4F7' }}>
            <Lottie source={require('../Global/netBankSuccess.json')} autoPlay loop style={{ height: 500, width: 500 }}></Lottie>
            <Text style={{ fontFamily: "NotoSans-ExtraBold", fontSize: 20 }}>Payment from your Net Banking is successful</Text>
...
export default NetBankPayAnime