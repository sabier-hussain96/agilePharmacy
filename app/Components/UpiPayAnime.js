...
const UpiPayAnime = () => {
  ...
  return (
    <View style={{ flex: 1, alignItems: 'center', margin: 'auto', backgroundColor: '#ADE4F7' }}>
            <Lottie source={require('../Global/Upisuccess.json')} autoPlay loop style={{ height: 500, width: 500 }}></Lottie>
            <Text style={{ fontFamily: "NotoSans-ExtraBold", fontSize: 20 }}>Payment Successful!!</Text>
