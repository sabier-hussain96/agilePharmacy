import { View, Text, PermissionsAndroid, useColorScheme } from 'react-native'
...
const LocationScreen = () => {
  ...
  return (
    ...
    <View style={{ flex: 1, backgroundColor: isDark ? "#000000" : "#FFFFFF", padding: 20 }}>
      <View style={{ flexDirection: 'row', justifyContent: "space-between" }}>
        <View style={AppStyleSheet.cancelText}>
          <Text style={{ fontSize: 28, fontFamily: "NotoSans-ExtraBold", color: isDark ? "#FFFFFF" : "#000000" }}>Choose your Location</Text>
        </View>
        <View style={AppStyleSheet.cancelIcon}>
          <TouchableOpacity onPress={() => {
            navigation.navigate(screenNames.Home_Screen)
          }}>
            <CancelIcon stroke={isDark ? "#FFFFFF" : "gray"} />
          </TouchableOpacity>
        </View>
      </View>
      ...
      <View style={{ marginTop: 20, alignItems: "center" }}>
        <Text style={{ color: isDark ? "#FFFFFF" : "#000000" }}>Your current Location</Text>

        <Text style={{ color: isDark ? "#FFFFFF" : "#000000" }}>Latitude: {location ? location.coords.latitude : null}</Text>
        <Text style={{ color: isDark ? "#FFFFFF" : "#000000" }}>Longitude: {location ? location.coords.longitude : null}</Text>
      ...
      <View style={AppStyleSheet.savedAddress}>
        <View>
          {location ?
            ...
            :
            <>
              <Text style={[AppStyleSheet.saveAddText,{color: isDark ? "#FFFFFF" : "#000000"}]}>Saved Addresses</Text>
              <View style={[AppStyleSheet.addressContainer,{color: isDark ? "#FFFFFF" : "#000000"}]}>
