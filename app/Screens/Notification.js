...
const Notification = () => {
  ...
  return (
    <View style={{ flex: 1,backgroundColor:isDark? '#000000':"#E0F2F1" }}>
      <View style={{ height: 60,width:"auto", borderWidth: 1}}>
        <Text style={{ fontFamily: "NotoSans-Bold", fontSize: 17, padding: 15, color:isDark?"#FFFFFF": "green"}}>Notifications</Text>
      </View>
      <ScrollView>
        <FlatList
        scrollEnabled={true}
        ...
        renderItem={({ item }) => (
          <View style={{ height: 60, width: "auto", borderRadius: 5, marginStart: 10, marginEnd: 10, marginTop: 20,
           borderColor:isDark?"#FFFFFF": "EDF2F9 ", borderWidth: 0.5,padding:5 }}>
